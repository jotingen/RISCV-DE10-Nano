...
TOP_LEVEL_NAME="terasic_hps_ddr3"
QSYS_SIMDIR="./../"
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/terasic_hps_ddr3_hps.v"          -work hps                     -cdslib ./cds_libs/hps.cds.lib                    
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/terasic_hps_ddr3.v"                                                                                                         
fi
